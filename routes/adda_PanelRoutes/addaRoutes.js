...
const { adgeUserSignup, adgeUserLogin, adgeAddForm, adgeQuestions, questionList, adgeDashboard, adgeUpdateTitle, adgeHome, adgeScore, adgetotalScore, saveDraft, exportsPDF, exportsUserPDF, updateQuestion, submit } = require("../../controllers/adda_Panel/adgeControllers")
const { s3upload } = require("../../middleware/multer")
const { addaUserSignup, addaUserLogin, addaHome, addaRoleAdd, addaRoleList, addaSearchRole, addaRoleUpdate, addaDeleteRole, addaUserAdd, addaUserList, addaUserUpdate, addaUserSearch, addaUserDelete, addaScheduleAdd, addaApprovedIn } = require("../../controllers/adda_Panel/addaControllers")
const { auditorUserSignup, auditorUserLogin, auditorHome, auditorRejected, auditorAprovedScore } = require("../../controllers/adda_Panel/auditorControllers")
